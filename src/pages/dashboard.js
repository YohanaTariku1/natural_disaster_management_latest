...
const Dashboard = ()=>{
    return(
        <>
            ...
            <div class="box-border h-60 w-78  border-2 bg-blue-900"> 
            <h1 className="text-center text-7xl  font-bold font-serif text-gray-50  pt-16">1000</h1> 
            <h1 className="text-center text-4xl  font-bold font-serif text-gray-50  pt-7">Customers</h1> 
            </div>
            <div class="box-border h-60 w-78  border-2 bg-blue-400"> 
            ...
            <div class="box-border h-60 w-78  border-2 bg-blue-200"> 
            <h1 className="text-center text-7xl  font-bold font-serif text-gray-700   pt-16">1000</h1> 
            <h1 className="text-center text-4xl  font-bold font-serif text-gray-700  pt-7">Customers</h1> 
            </div>
            <div class="box-border h-60 w-78  border-2 bg-blue-900"> 
